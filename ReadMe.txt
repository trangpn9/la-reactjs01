1. Create Laravel core sevice for multi site!
  1.1: Config database + up load default database => Done
  1.2: Create UserController is controller Resource => Done
  1.3: Create middleware Cors for transmission data within server and client => Done
  1.4: Create function in UserController get all data form User database => Done
  1.5: Create Route API resource => Done
